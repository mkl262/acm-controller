...
// +kubebuilder:rbac:groups=acm.services.k8s.aws,resources=acmeendpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=acm.services.k8s.aws,resources=acmeendpoints/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"Contact"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.Contact != nil && latestKo.Spec.Contact == nil {
		latestKo.Spec.Contact = observedKo.Spec.Contact
	}
