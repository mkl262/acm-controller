...
const (
	FinalizerString = "finalizers.acm.services.k8s.aws/AcmeEndpoint"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("acmeendpoints")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AcmeEndpoint{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AcmeEndpoint),
	}
}
